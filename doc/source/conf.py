...
# -*- coding: utf-8 -*-
#
# py_trees_ros documentation build configuration file, created by
# sphinx-quickstart on Sun Mar 24 22:41:12 2019.
#
...
latex_documents = [
    (master_doc, 'py_trees_ros.tex', 'py\\_trees\\_ros Documentation',
     'Daniel Stonier', 'manual'),
]
...
man_pages = [
    (master_doc, 'py_trees_ros', 'py_trees_ros Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'py_trees_ros', 'py_trees_ros Documentation',
     author, 'py_trees_ros', 'One line description of project.',
     'Miscellaneous'),
]

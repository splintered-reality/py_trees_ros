...
Refer to the package documentation ([py_trees](http://py-trees.readthedocs.io/en/devel/) & [py_trees_ros](https://stonier.github.io/py_trees_ros/)) for more information).

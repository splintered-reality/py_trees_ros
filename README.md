...
|:---:|:---:|:---:|:---:|:---:|:---:|
| [py_trees][py-trees-ros-index] | [![2.5.x][2.5.x-sources-image]][py-trees-sources-2.5.x]<br/>[![Build Status][py-trees-build-status-rolling-image]][py-trees-build-status-rolling]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-sources-2.5.x]<br/>[![Build Status][py-trees-build-status-lyrical-image]][py-trees-build-status-lyrical]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-sources-2.5.x]<br/>[![Build Status][py-trees-build-status-kilted-image]][py-trees-build-status-kilted]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-sources-2.5.x]<br/>[![Build Status][py-trees-build-status-jazzy-image]][py-trees-build-status-jazzy]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-sources-2.5.x]<br/>[![Build Status][py-trees-build-status-humble-image]][py-trees-build-status-humble]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-docs-2.5.x] |
...
| [py_trees_ros][py-trees-ros-ros-index] | [![2.5.x][2.5.x-sources-image]][py-trees-ros-sources-2.5.x]<br/>[![Build Status][py-trees-ros-build-status-rolling-image]][py-trees-ros-build-status-rolling]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-ros-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-ros-sources-2.5.x]<br/>[![Build Status][py-trees-ros-build-status-lyrical-image]][py-trees-ros-build-status-lyrical]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-ros-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-ros-sources-2.5.x]<br/>[![Build Status][py-trees-ros-build-status-kilted-image]][py-trees-ros-build-status-kilted]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-ros-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-ros-sources-2.5.x]<br/>[![Build Status][py-trees-ros-build-status-jazzy-image]][py-trees-ros-build-status-jazzy]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-ros-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-ros-sources-2.5.x]<br/>[![Build Status][py-trees-ros-build-status-humble-image]][py-trees-ros-build-status-humble]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-ros-docs-2.5.x] |
| [py_trees_ros_tutorials][py-trees-ros-tutorials-ros-index] | [![2.5.x][2.5.x-sources-image]][py-trees-ros-tutorials-sources-2.5.x]<br/>[![Build Status][py-trees-ros-tutorials-build-status-rolling-image]][py-trees-ros-tutorials-build-status-rolling]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-ros-tutorials-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-ros-tutorials-sources-2.5.x]<br/>[![Build Status][py-trees-ros-tutorials-build-status-lyrical-image]][py-trees-ros-tutorials-build-status-lyrical]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-ros-tutorials-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-ros-tutorials-sources-2.5.x]<br/>[![Build Status][py-trees-ros-tutorials-build-status-kilted-image]][py-trees-ros-tutorials-build-status-kilted]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-ros-tutorials-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-ros-tutorials-sources-2.5.x]<br/>[![Build Status][py-trees-ros-tutorials-build-status-jazzy-image]][py-trees-ros-tutorials-build-status-jazzy]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-ros-tutorials-docs-2.5.x] | [![2.5.x][2.5.x-sources-image]][py-trees-ros-tutorials-sources-2.5.x]<br/>[![Build Status][py-trees-ros-tutorials-build-status-humble-image]][py-trees-ros-tutorials-build-status-humble]<br/>[![2.5.x-Docs][2.5.x-rtd-image]][py-trees-ros-tutorials-docs-2.5.x] |
...
[2.5.x-sources-image]: http://img.shields.io/badge/sources-2.5.x-blue.svg?style=plastic
[2.4.x-sources-image]: http://img.shields.io/badge/sources-2.4.x-blue.svg?style=plastic
...
[2.5.x-rtd-image]: https://readthedocs.org/projects/py-trees/badge/?version=release-2.5.x&style=plastic
[2.4.x-rtd-image]: https://readthedocs.org/projects/py-trees/badge/?version=release-2.4.x&style=plastic
...
[py-trees-docs-2.5.x]: http://py-trees.readthedocs.io/en/release-2.5.x/
[py-trees-docs-2.4.x]: http://py-trees.readthedocs.io/en/release-2.4.x/
...
[py-trees-sources-2.5.x]: https://github.com/splintered-reality/py_trees/tree/release/2.5.x
[py-trees-sources-2.4.x]: https://github.com/splintered-reality/py_trees/tree/release/2.4.x
...
[py-trees-ros-interfaces-sources-2.4.x]: https://github.com/splintered-reality/py_trees_ros_interfaces/tree/release/2.4.x
...
[py-trees-ros-docs-2.5.x]: http://py-trees-ros.readthedocs.io/en/release-2.5.x/
[py-trees-ros-docs-2.4.x]: http://py-trees-ros.readthedocs.io/en/release-2.4.x/
...
[py-trees-ros-sources-2.5.x]: https://github.com/splintered-reality/py_trees_ros/tree/release/2.5.x
[py-trees-ros-sources-2.4.x]: https://github.com/splintered-reality/py_trees_ros/tree/release/2.4.x
...
[py-trees-ros-tutorials-docs-2.5.x]: http://py-trees-ros-tutorials.readthedocs.io/en/release-2.5.x/
[py-trees-ros-tutorials-docs-2.4.x]: http://py-trees-ros-tutorials.readthedocs.io/en/release-2.4.x/
...
[py-trees-ros-tutorials-sources-2.5.x]: https://github.com/splintered-reality/py_trees_ros_tutorials/tree/release/2.5.x
[py-trees-ros-tutorials-sources-2.4.x]: https://github.com/splintered-reality/py_trees_ros_tutorials/tree/release/2.4.x
